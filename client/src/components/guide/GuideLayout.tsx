      ...
      `}>
        ...
        <div className="px-8 py-8 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tighter uppercase whitespace-nowrap">TripBuddy</h1>
              <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest -mt-1">Guide Professional</p>
            </div>
          </div>
          <button 
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <Icon size={20} className={location.pathname === path ? 'text-white' : 'group-hover:text-indigo-400 group-hover:scale-110 transition-transform'} />
                  {name}
                </div>
        ...
        <header className="bg-white/80 backdrop-blur-md px-6 lg:px-10 py-5 border-b border-slate-100 flex justify-between items-center sticky top-0 z-30">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">{getPageTitle()}</span>
            </div>
          </div>
