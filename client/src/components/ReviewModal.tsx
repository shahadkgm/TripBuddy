...
const ReviewModal: React.FC<ReviewModalProps> = ({ tripId, onClose, onSuccess, target = 'organizer', targetName }) => {
            ...
            <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    <div className="flex flex-col items-center gap-4">
                        <label className="text-sm font-bold text-slate-700 uppercase tracking-wider">Select Rating</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-slate-700 uppercase tracking-wider">Share your thoughts</label>
                        <textarea
                            value={comment}
