            ...
            <div className="bg-[#5537ee] p-3 rounded-xl">
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="M12 21s-8-4-8-10a8 8 0 1116 0c0 6-8 10-8 10z"
                />
              </svg>
            </div>
          </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          {isRegister ? (
            <>
              ...
              <Link to="/login" className="text-[#5537ee] font-semibold hover:underline">
                Log in
              </Link>
            </>
          ) : (
            <>
              ...
              <Link to="/register" className="text-[#5537ee] font-semibold hover:underline">
                Sign up
              </Link>
            </>
          )}
