                        ...
                        trip.itinerary.map((day, idx) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <h4 className="text-xs lg:text-sm font-black uppercase tracking-tight mb-2">
                                Day {idx + 1}
                              </h4>
                              <div className="space-y-1.5">
                                {day.activities && day.activities.length > 0 ? (
                                  day.activities.map(
                                    (act: { time: string; activity: string }, i: number) => (
                                      <div
                                        key={i}
                                        className="flex gap-2 items-start text-[10px] lg:text-xs text-slate-500 font-medium leading-relaxed"
                                      >
                                  ...
                                  <p className="text-[10px] lg:text-xs text-slate-400 italic">
      ...
      {showRejectModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          <div
            ...
            onClick={() => !responding && setShowRejectModal(false)}
          />
            ...
            <div className="mb-8 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">
                  Help the traveler understand why
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 flex gap-4">
              ...
              >
                {responding ? (
                  ...
                  <>
                    Confirm Decline <XCircle size={14} />
                  </>
                )}
              </button>
            </div>
