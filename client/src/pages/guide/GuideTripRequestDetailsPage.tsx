...
//                     {/* Hero Section */}
//                     <div className="bg-white rounded-[2rem] lg:rounded-[3rem] overflow-hidden shadow-2xl shadow-slate-200/50 border border-slate-100 mb-10">
...
//                                     <div className="bg-slate-900 rounded-[2rem] lg:rounded-[2.5rem] p-8 text-white shadow-2xl shadow-indigo-200/50">
//                                         <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-400 mb-6">Organizer Details</h3>
//                                         <div className="flex items-center gap-4 mb-8">
//                                             <div className="w-14 h-14 lg:w-16 lg:h-16 rounded-xl lg:rounded-2xl bg-indigo-600 flex items-center justify-center text-xl lg:text-2xl font-black border border-white/20 overflow-hidden">
