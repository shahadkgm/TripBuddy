          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-slate-500 font-medium">
                Track your trip deposits and refund status
              </p>
            </div>
            <div className="flex flex-wrap gap-4">
              ...
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-3 bg-gradient-to-br from-emerald-50/30 to-white">
                ...
                <div>
                  <div className="text-[10px] font-bold text-emerald-600/60 uppercase tracking-widest leading-none mb-1">
                    Wallet Balance
                  </div>
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-3xl p-12 text-center border border-slate-100 shadow-sm">
              ...
              <p className="text-slate-500 max-w-xs mx-auto mt-2">
                When you pay for a trip deposit, your history will appear here.
              </p>
            </div>
          ) : (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-start gap-4">
                      <div
                        className={`p-3 rounded-xl ${getStatusStyles(payment.status)} bg-opacity-40`}
                      >
                        <CreditCard size={20} />
                      </div>
                      <div>
                    ...
                    <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-2">
                      ...
                      <div
                        className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${getStatusStyles(payment.status)}`}
                      >
