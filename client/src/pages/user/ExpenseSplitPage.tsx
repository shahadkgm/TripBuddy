                  ...
                  {expenses.length > 0 && (
                    <tfoot className="bg-slate-50 border-t border-slate-100">
                      <tr>
                        <td
                          colSpan={3}
                          className="px-8 py-5 text-right font-bold text-slate-500 uppercase text-[10px] tracking-widest"
                        >
                          Total Per Person:
                        </td>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6">
                {Object.entries(calculateBalances()).map(([name, total]) => (
                  <div
                    key={name}
                    className="bg-white/10 backdrop-blur-md p-5 rounded-[24px] border border-white/10 flex justify-between items-center animate-in zoom-in-95 duration-300"
                  >
                ...
                {expenses.length === 0 && (
                  <div className="py-10 text-center opacity-60 flex flex-col items-center gap-4">
                    ...
                    <p className="italic font-medium">
                      Add an expense to start tracking settlements.
                    </p>
                  </div>
                )}
              </div>
