          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-slate-500 text-base md:text-xl font-medium leading-relaxed max-w-lg">
                We travel not to escape life, but for life not to escape us. Trip Buddy is here to
                remove the stress.
              </p>
                ...
                {[
                  {
                    ...
                    desc: 'Detailed stop-by-stop itineraries.',
                  },
                  {
                    icon: '👥',
                    title: 'Traveler Network',
                    desc: 'Connect with like-minded buddies.',
                  },
                  ...
                  >
                    <span className="text-xl md:text-3xl mb-1 lg:mb-3 block group-hover:scale-125 transition-transform">
                      {item.icon}
                    </span>
                    <h4 className="font-bold text-slate-800 text-[10px] md:text-sm mb-0.5 lg:mb-1">
                      {item.title}
                    </h4>
            ...
            >
              ...
              <div className="absolute top-4 lg:top-8 left-4 lg:left-8 z-10">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/20"></div>
              </div>
              ...
              <div className="absolute bottom-4 lg:bottom-8 left-4 lg:left-8 right-4 lg:right-8 z-10">
                <div className="bg-white/20 backdrop-blur-md p-4 lg:p-6 rounded-xl lg:rounded-3xl border border-white/30 text-white">
                  <p className="text-[8px] lg:text-[10px] font-bold uppercase tracking-widest mb-0.5 lg:mb-1 opacity-80">
                    Explore The World
                  </p>
                  <h3 className="text-base lg:text-2xl font-black leading-none mb-0.5 lg:mb-1">
                    Unforgettable Journeys
                  </h3>
                  <p className="text-[10px] lg:text-xs font-medium opacity-90">
                    Find buddies for your next big adventure.
                  </p>
                </div>
              </div>
            </motion.div>
