        ...
        <div className="max-w-7xl mx-auto">
                ...
                {isEditing ? (
                  <div className="space-y-4 w-full max-w-md">
                    <div className="flex flex-col gap-1">
                      ...
                      />
                      {errors.name && (
                        <p className="text-[10px] text-red-500 font-bold mt-1 pl-1 flex items-center gap-1">
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span
                          className={`text-[10px] font-bold ${editData.bio.length > 180 ? 'text-amber-500' : 'text-slate-300'}`}
                        >
                ...
                {isEditing ? (
                  <>
                    <button
                      onClick={handleSave}
                      disabled={isSaving}
                      className="px-8 py-3 bg-indigo-600 text-white rounded-xl font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50"
                    >
                      {isSaving ? (
                  ...
                  <>
                    <button
                      ...
                      className="px-8 py-3 bg-white text-slate-800 rounded-xl font-bold shadow-sm hover:bg-slate-50 transition-all flex items-center gap-2 border border-slate-100"
                    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-100">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl border border-slate-50">
                  ...
                  <span
                    className={`text-[10px] font-bold px-3 py-1 rounded-md uppercase tracking-widest ${kycStatus === 'approved' ? 'bg-green-50 text-green-600' : 'bg-amber-50 text-amber-600'}`}
                  >
                    {kycStatus}
                  </span>
                </div>
                {requests.length > 0 && (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-4 bg-indigo-50 text-indigo-700 rounded-xl font-bold text-xs ring-1 ring-indigo-100"
                  >
                    <div className="flex items-center gap-2">
                      <UserCheck size={14} /> {requests.length} Pending Connections
                    </div>
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition cursor-default">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-400 text-[10px] uppercase tracking-wider font-bold mt-1">
                    Ready to use for next trip
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-100">
              ...
              <div className="space-y-4">
                <p className="text-sm text-slate-500 font-medium">
                  Showcase your personal travel memories. Only you and your connected travelers can
                  see this.
                </p>
                <button
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-100">
              ...
              <div className="space-y-4">
                <p className="text-sm text-slate-500 font-medium">
                  View your transaction history, trip deposits, and refund status in one place.
                </p>
                <button
                  onClick={() => navigate('/my-payments')}
                  className="w-full py-4 bg-[#5537ee] text-white rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 flex items-center justify-center gap-2"
                >
            ...
            <div className="lg:col-span-1 bg-white p-8 rounded-xl shadow-lg border border-slate-100">
              <div className="mt-2 text-center flex flex-col items-center">
                ...
                <p className="text-xs text-slate-400 mb-6">
                  Your personal 24/7 AI-powered travel buddy for trips and planning.
                </p>
                <button
            ...
            <div className="p-6">
              ...
              <form onSubmit={handlePasswordChange} className="space-y-4">
                <div className="space-y-1">
                  ...
                  />
                  {errors.oldPassword && (
                    <p className="text-[10px] text-red-500 font-bold mt-1 pl-1 animate-in slide-in-from-left-2">
                      {errors.oldPassword}
                    </p>
                  )}
                </div>
