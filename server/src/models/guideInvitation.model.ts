...
guideInvitationSchema.index({ tripId: 1, guideId: 1 }, { unique: true, partialFilterExpression: { status: InvitationStatus.PENDING } });

export const GuideInvitationModel = model<IGuideInvitationDocument>('GuideInvitation', guideInvitationSchema);
